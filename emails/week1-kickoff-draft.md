...
By the end of this semester, you will have researched, prototyped, and documented a unified engagement system integrating:
- AI voice bots
- WhatsApp Business API
- Email, SMS, and web chat

With working prototypes and production-ready vendor recommendations.
...
- Lead: Rujul Shukla
- Members: Nikita, Chanakya, Ananth, Harshith
- Focus: Technical infrastructure, WhatsApp/voice bot platforms, system integration

**Team 4B — Marketing Automation & UX Strategy**
- Lead: Sysha Sharma
- Members: Rohan, Leena, Subodh, Chakradhar
- Focus: Marketing strategy, user experience, multi-channel engagement design

---

## WEEK 1 ASSIGNMENT: RESEARCH SPRINT

Your Week 1 mission is intense discovery. You will research platforms, discover new tools, and design architectures — pushing beyond obvious choices to find emerging solutions.

### All details are in your GitHub READMEs:

**Team 4A:** https://github.com/confersolutions/utd-innovation-lab-2026/blob/main/4A/README.md

**Team 4B:** https://github.com/confersolutions/utd-innovation-lab-2026/blob/main/4B/README.md

### Key Requirements:

1. **Discover NEW tools** — At least 2 per category that haven't been mentioned
2. **Use Perplexity Flow** for research — export and commit your research logs
3. **All deliverables in Markdown** — commit to your team folder in GitHub
4. **Cost analysis at 3 scales** — 1K / 10K / 100K users
5. **Working prototypes encouraged** — spin up trials when possible
...
- Show your work — Perplexity logs, not just conclusions
- Push hard — this should keep you genuinely busy all week
- Quality over speed — but consistency matters

---

## RESOURCES

Main repo: https://github.com/confersolutions/utd-innovation-lab-2026

Team 4A focuses on: WhatsApp Business API, voice bots (VAPI, ElevenLabs, etc.), automation layers (n8n, etc.), and integration architecture for radhakrishnatemple.net and jkyog.org.

Team 4B focuses on: Digital presence audit, competitive analysis (including dallashanuman.org), marketing automation tools (Go High Level, Podium, etc.), user journey maps, and channel strategy.
